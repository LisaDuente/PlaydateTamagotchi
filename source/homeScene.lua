...
function HomeScene:init(pet)
    local backgroundImage = gfx.image.new("images/BackgroundRoom")
...
function HomeScene:grabDetection()
...
function HomeScene:inputHandler()
    if pd.buttonJustPressed(pd.kButtonB) then
        ...
        SCENE_MANAGER:switchScene(OutdoorScene, self.pet)
    end
